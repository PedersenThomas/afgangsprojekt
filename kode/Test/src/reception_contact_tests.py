...
class ReceptionContactTests(unittest.TestCase):
    ...
    def test_updateNewReceptionContact(self):
        ...
        try:
            ...
            assert newReceptionContact['wants_messages'] == receptionContact['wants_messages']

            newWantsMessages = False
            #Do the changes to the object.
            newReceptionContact['wants_messages'] = newWantsMessages
            ...
            assert updatedReceptionContact['wants_messages'] == newWantsMessages
