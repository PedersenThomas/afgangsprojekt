...
CREATE SEQUENCE messaging_addresses_id_sequence
  START WITH 1
  INCREMENT BY 1
  NO MINVALUE
  NO MAXVALUE
  CACHE 1;
ALTER SEQUENCE messaging_addresses_id_sequence OWNED BY messaging_addresses.id;
ALTER TABLE ONLY messaging_addresses ALTER COLUMN id SET DEFAULT nextval ('messaging_addresses_id_sequence'::regclass);
...
ALTER TABLE openids OWNER TO alice;
ALTER TABLE dial_plans OWNER TO alice;
ALTER TABLE audiofiles OWNER TO alice;
...
ALTER TABLE messaging_addresses OWNER TO alice;
...
ALTER SEQUENCE messaging_addresses_id_sequence OWNER TO alice;
